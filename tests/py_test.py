...
class PyTest(unittest.TestCase):
    ...
    def assertDictContains(self, actual, expected):
        ...
        return self.assertEqual(
            {k: actual.get(k, ValueMissing) for k, v in expected.items()}, expected
        )
    ...
    def test_doc(self):
        ...
        # Function
        d = exdoc.doc(h)
        self.assertEqual(d.pop("module"), "py_test")
        ...
        self.assertEqual(
            d.pop("rtsignature"), "h(a, b, c=True, d=1, *args, **kwargs) -> None"
        )
        self.assertEqual(
            d.pop("tsignature"),
        ...
        self.assertEqual(
            d.pop("qrtsignature"), "h(a, b, c=True, d=1, *args, **kwargs) -> None"
        )
        self.assertEqual(
            d.pop("qtsignature"),
            "h(a: int, b, c: None=True, d=1, *args, **kwargs) -> None",
        ...
        self.assertEqual(d.pop("exc"), [{"name": "AssertionError", "doc": "sometimes"}])
        ...
        self.assertEqual(
            d.pop("args"), [{"name": "a", "type": None, "doc": "", "default": 1}]
        )
        self.assertEqual(d.pop("exc"), [])
        self.assertEqual(d.pop("example"), None)
        self.assertEqual(d, {})
        ...
        self.assertEqual(
            d.pop("args"), [{"name": "a", "type": None, "doc": "", "default": 2}]
        )
        self.assertEqual(d.pop("exc"), [])
        self.assertEqual(d.pop("example"), None)
        self.assertEqual(d, {})
        ...
        self.assertEqual(d.pop("ret"), None)
        self.assertEqual(
            d.pop("args"), [{"name": "a", "type": None, "doc": "", "default": 3}]
        )
        self.assertEqual(d.pop("exc"), [])
        self.assertEqual(d.pop("example"), None)
        self.assertEqual(d, {})
        ...
        self.assertEqual(
            d.pop("qrtsignature"), "C.p(self)"
        )  # FIXME: wrong name for properties!
        self.assertEqual(
            d.pop("qtsignature"), "C.p(self)"
        )  # FIXME: wrong name for properties!
        self.assertEqual(d.pop("signature"), "p")
        self.assertEqual(d.pop("rtsignature"), "p(self)")
        self.assertEqual(
            d.pop("tsignature"), "p(self)"
        )  # FIXME: wrong name for properties!
    ...
    def test_google_docstring(self):
        ...
        self.assertEqual(d["args"], [{"name": "a", "type": None, "doc": "a\n    b\nc"}])
